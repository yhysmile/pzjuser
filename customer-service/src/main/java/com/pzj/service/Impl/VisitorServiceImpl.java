...
import com.pzj.core.customer.visitor.CreateVisitorRequest;
import com.pzj.core.customer.visitor.ModifyVisitorRequest;
import com.pzj.core.customer.visitor.QueryVisitorDetailResponse;
import com.pzj.core.customer.visitor.QueryVisitorRequest;
import com.pzj.core.customer.visitor.QueryVisitorSummaryResponse;
import com.pzj.core.customer.visitor.VisitorReadEngine;
import com.pzj.core.customer.visitor.VisitorService;
import com.pzj.core.customer.visitor.VisitorWriteEngine;
...
public class VisitorServiceImpl implements VisitorService {
	...
	public Result<ArrayList<QueryVisitorSummaryResponse>> queryVisitorSummaryByNameMobile(String nameMobile) {
		...
		if (null == nameMobile || "".equals(nameMobile.trim())) {
			result.setErrorCode(CustomerExceptionCode.PARAMETER_EMPTY.getCode());
			result.setErrorMsg(CustomerExceptionCode.PARAMETER_EMPTY.getMsg());
