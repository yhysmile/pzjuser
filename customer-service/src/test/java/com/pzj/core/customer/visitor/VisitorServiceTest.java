...
public class VisitorServiceTest {
	...
	public void queryVisitorByNameMobile() {
		String nameMobile = "张三那";
		Long supplierId = 123123123L;
		Result<ArrayList<QueryVisitorSummaryResponse>> result = visitorService
				.queryVisitorSummaryByNameMobile(nameMobile);
