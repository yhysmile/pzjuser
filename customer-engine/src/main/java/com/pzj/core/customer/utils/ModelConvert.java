...
public class ModelConvert {
	...
	public static QueryChannelResponse convertChannelResponse(SysChannel sysChannel) {
	...
	public static List<QueryChannelResponse> convertChannelResponses(List<SysChannel> sysChannels) {
		List<QueryChannelResponse> cList = new ArrayList<QueryChannelResponse>();
		if (Check.NuNObject(sysChannels)) {
			return cList;
		}
		for (SysChannel sysC : sysChannels) {
			cList.add(convertChannelResponse(sysC));
		}
		return cList;
	}
