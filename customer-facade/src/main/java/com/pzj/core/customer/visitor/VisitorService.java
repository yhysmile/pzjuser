...
public interface VisitorService {
	 ...
	 *
	 */
	Result<QueryResult<QueryVisitorSummaryResponse>> queryVisitorSummaryByPage(QueryVisitorRequest queryVisitorRequest,
			PageBean page);
	 ...
	 *
	 */
	Result<ArrayList<QueryVisitorSummaryResponse>> queryVisitorSummaryByNameMobile(String nameMobile);
}
