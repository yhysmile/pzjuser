...
public class QueryCustomerRequest implements Serializable {
	 ...
	 */
	private Integer querType;

	/**
	 * Getter method for property <tt>querType</tt>.
	 * 
	 * @return property value of querType
	 */
	...
	/**
	 * Setter method for property <tt>querType</tt>.
	 * 
	 * @param querType value to be assigned to property querType
	 */
	public void setQuerType(Integer querType) {
