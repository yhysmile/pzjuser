...
public interface SysChannelMapper extends BaseUserMapper<SysChannel> {
	 ...
	 * @return
	 */
	List<SysChannel> selectChannelContainUser(@Param("bParam") SysChannel sysChannel, @Param("user") SysUser user,
			@Param("pParam") PageModel pageModel);
	 ...
	 * @return
	 */
	int countChannelContainUser(@Param("bParam") SysChannel sysChannel, @Param("user") SysUser user);
	 ...
	 * @return
	 */
	int countChannelContainNotUser(@Param("bParam") SysChannel sysChannel, @Param("user") SysUser user,
	 ...
	 * @return
	 */
	List<SysChannel> queryChannelsUserNotJoin(@Param("bParam") SysChannel sysChannel, @Param("user") SysUser user,
			@Param("pParam") PageModel pageModel, @Param("channelIds") List<Long> channelIds);

	List<ChannelUsers> queryChannelUsers(@Param("channel") SysChannel sysChannel);
}
